...
public class EmployeesApp {
    ...
    public static List<Employee> getSelectedEmployeesWithTitleCurrentSalary(double filterTotalSalaryEarned) {
        return emplDao.getSelectedWithTitleCurrentSalary(filterTotalSalaryEarned);
    }
